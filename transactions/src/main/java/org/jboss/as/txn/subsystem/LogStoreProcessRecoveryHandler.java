...
public class LogStoreProcessRecoveryHandler implements OperationStepHandler {
    ...
    public void execute(OperationContext context, ModelNode operation) throws OperationFailedException {
        ArjunaRecoveryManagerService recoveryManagerService = (ArjunaRecoveryManagerService) context.getServiceRegistry(false)
                .getRequiredService(ArjunaRecoveryManagerService.SERVICE_NAME).getValue();
        recoveryManagerService.scan();
    }
